...
const STATS = [
  { value: "15", label: "Internal Systems", sub: "In Production" },
  { value: "29K+", label: "Records", sub: "Processed" },
  { value: "Solo", label: "Full Stack", sub: "Developer" },
  { value: "1+", label: "Professional", sub: "Experience" },
];
          ...
          >
            ...
            <motion.div variants={entranceItem}>
              ...
              <h1 className="hero-title">
                ...
                {/* <span className="hero-title-dim">& Software Engineer.</span> */}
              </h1>
            </motion.div>

            <motion.p variants={entranceItem} className="hero-desc">
              I develop and maintain business-critical software using Laravel, React,
              TypeScript, MySQL, C#/.NET, and Linux — supporting real internal workflows,
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="hero-status-text">Open to new opportunities</p>
                </motion.div>
              </motion.div>
            </motion.div>
          </motion.div>
